...
A diferencia de los modelos estadísticos tradicionales (como SARIMAX), XGBoost no entiende la noción de "tiempo" intrínsecamente. Por ello, transformamos la serie en un problema de aprendizaje supervisado mediante:
